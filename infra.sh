...
az vm create --resource-group bernocchi2025 --name bernocchi2025-vm --public-ip-address "" --image Ubuntu2204 --admin-username azureuser --generate-ssh-keys --vnet-name bernocchi2025-vnet --subnet server --size Standard_B1s
...
az network bastion tunnel --resource-group bernocchi2025 --name bernocchi2025-bastion --target-resource-id $(az vm show --resource-group bernocchi2025 --name bernocchi2025-vm --query id -o tsv) --resource-port 22 --port 50000
# Connect to the VM using the tunnel
ssh -i ~/.ssh/id_rsa azureuser@localhost -p 50000